            ...
            <div class="my-card">
                <q-card flat>
                    ...
                    <div class="kartu q-gutter-md">
                        ...
                        <q-input standout="bg-teal text-white" v-model="password" label="password" :dense="dense" bg-color="blue-grey-5" type="password"/>
                        <div class="row">
                        ...
                        <div style="margin-left: 25%; margin-right: 25%;">
                            ...
                            <q-btn label="REGISTRASI" style="color: #2A5870; background-color: white; width: 100%; border-radius: 10px" />
                        </div>
                    </div>
                </q-card>
            </div>
